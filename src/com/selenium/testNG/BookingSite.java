...
public class BookingSite {
    ...
    public void setup() {
        ...
        System.setProperty("webdriver.gecko.driver", "C:\\Users\\Ja\\Desktop\\Patrycja\\Dokumenty\\KURS\\Repo_se\\resources\\geckodriver.exe");
        driver = new FirefoxDriver();
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        driver.get("https://booking.com");
        //Inicjalizujemy wszystkie elemnty strony opisane w atrybutach klasy
